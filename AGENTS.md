...
- `lib/`: Domain and integration code (`lib/supabase`, `lib/ai`, and post permission helpers).
...
- Call out env/config changes explicitly (`NEXT_PUBLIC_SUPABASE_URL`, `NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY`, `GEMINI_API_KEY`).
